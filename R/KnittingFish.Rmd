...
text(b[,1], -500, srt = 60, adj= 1, xpd = TRUE, labels = my_vector , cex=0.5)
### *Discards*
Discards (mt) for Pollock in US waters of areas 5 & 6 (Northeast Fisheries Science Center, 2010).

```{r pollockD, echo=FALSE, message=FALSE}
library("readxl")
datafilePD <-  read_excel("~/Documents/NOAA/Stock Assessment/pollock.xlsx", sheet= 3, skip=2) 


b <- barplot(datafilePD$Total_Discards, main = "Pollock Total Discards", 
             axisnames=TRUE, xlab="Year", ylab= "Total Discards (mt)", names.arg= "", cex.axis= 0.6)
my_vector <- 1989:2008
